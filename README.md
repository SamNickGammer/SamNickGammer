...
Hey there! I'm a **Full Stack Developer** with **3+ years** of experience building scalable web applications and AI-driven solutions. Currently working at **PepsiCo** as a Frontend Developer, where I led the PepsiConnect platform to **1M+ users**. I'm passionate about creating innovative solutions that make a real impact.

**💼 Currently:** Frontend Developer @ PepsiCo (Remote, Hyderabad, IN)  
**🎯 Focus:** Gen AI Development, Blockchain Research, and Scalable Web Solutions  
**🌱 Learning:** Advanced AI integrations, Web3 technologies, and cutting-edge frontend frameworks  
**⚡ Fun Fact:** I turn coffee ☕ into code 💻 and love building things that matter!
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/omprakashbharati) [![Portfolio](https://img.shields.io/badge/Portfolio-%23000000.svg?style=for-the-badge&logo=firefox&logoColor=#FF7139)](https://samnickgammer.github.io) [![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ombharatiofficial@gmail.com) [![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SamNickGammer)

**💻 Coding Platforms:**  
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=LeetCode&logoColor=black)](https://leetcode.com/samnickgammer) [![HackerRank](https://img.shields.io/badge/-Hackerrank-2EC866?style=for-the-badge&logo=HackerRank&logoColor=white)](https://www.hackerrank.com/samnickgammer_) [![HackerEarth](https://img.shields.io/badge/HackerEarth-%232C3454.svg?style=for-the-badge&logo=HackerEarth&logoColor=Blue)](https://www.hackerearth.com/@samnickgammer/) [![GeeksForGeeks](https://img.shields.io/badge/GeeksforGeeks-gray?style=for-the-badge&logo=geeksforgeeks&logoColor=35914c)](https://www.geeksforgeeks.org/profile/samnickgammer) [![CodeChef](https://img.shields.io/badge/CodeChef-%23964B00.svg?style=for-the-badge&logo=CodeChef&logoColor=white)](https://www.codechef.com/users/samnickgammer)
...
**Frontend Developer @ PepsiCo** *(Aug 2025 – Present)*  
- Architected and led front-end development for PepsiCo Enterprise Admin Portal serving millions of global users
- Spearheaded UX/UI enhancements for PepsiConnect, achieving **1M+ users** milestone recognized in Global Townhall
- Built scalable solutions using React.js, Nest.js, and React Native, earning executive recognition for "relentless efforts"

**Full Stack Developer (MERN/Nest) @ BTICS** *(Feb 2023 – Aug 2025)*  
- Led development of matrimonial platform using React.js, Nest.js, and React Native, enhancing user interactions by **28%**
- Collaborated with DRIP's Head of Tech to revamp product UI, increasing retention by **10%** and seller traffic by **35%**
- Built scalable casino platform admin panel with real-time analytics, boosting operational efficiency by **60%**
- Integrated YouTube Broadcast and Twitch streaming via OAuth, resulting in **45% sales increase**

**Frontend Developer Intern @ ANIWORKS INNOVATION COMPANY** *(April 2022 – Jan 2023)*  
- Engineered e-Patra Email Services with PGP encryption and 1TB file handling for 1,000+ active users
- Built Mini Photo Album with multi-cloud support, improving platform engagement by **40%**
...
**📧 e-Patra: Secure Email Services** *(Aug 2022 - Jan 2023)*  
High-performance email platform with PGP encryption, handling 1TB+ file uploads and securing communications for **10,000+ users**. Built with React (TypeScript) and Node.js.

**🎨 JSON Visualizer** *(Dec 2023)*  
Interactive tree-structured UI tool for JSON visualization, improving debugging efficiency and developer productivity by **20%**.

**😷 Real-Time Face Mask Detection** *(Sep 2021)*  
Python-based computer vision system achieving **95% accuracy** in detecting face masks for COVID-19 compliance.
...
**🏅 Awards:**  
- 🥈 2nd Place - X-Coder Competition, Amity University (2020)
- 🎓 SmartKnower Campus Ambassador, AUK (2020-21)
- 🌟 Global Townhall Recognition - PepsiCo Q4 2024
- 🚀 1M+ Users Achievement - PepsiConnect Platform

**📜 Certifications:**  
- ⚛️ React 18 - Codedamn
- 💻 Problem Solving (PS0) - HackerRank
- 📊 Google Analytics - Google
- ☁️ Cloud Computing - Udemy
- 🌐 Master Web Development - Swifsys Technologies

**🔬 Research:**  
- Decentralized Social Networks - Social media platforms based on blockchain and Ganache technology

**🌍 Languages:**  
Fluent in English and Hindi | Conversational in French
...
![Profile Views](https://komarev.com/ghpvc/?username=SamNickGammer&style=for-the-badge&color=blueviolet)
